# This script makes use of the scripts calculate_template_dependent_metrics and calculate_template_independent_metrics to process the AlphaFold prediction result of minimal DMI.
# Author: Chop Yan Lee
